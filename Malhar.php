...
if(!isset($_SESSION['malhar']) || $_SESSION['malhar'] !==true)
{
    ...
    <section id="menu" class="section-p1">
        <div class="pro-container">
            ...
            <div class="des">
                ...
                <input type="hidden" name="Item_Name" value="Veg. Thali">
                <input type="hidden" name="price" Value="90">
                <input type="hidden" name="Hotel_id" Value="1001">
                </form>
                </li>
                </ul>
            </div>
        ...
        <div class="pro-container">
            ...
            <div class="des">
                ...
                <input type="hidden" name="Item_Name" value="Paneer Rice">
